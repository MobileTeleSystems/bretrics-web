...
2. Send a detailed report to the repository maintainer via:
   - GitHub Security Advisory: [Report a vulnerability](https://github.com/MobileTeleSystems/bretrics-web/security/advisories/new)
   - Email: Create an issue in the [issue tracker](https://github.com/MobileTeleSystems/bretrics-web/issues) marked as **Security** (if no sensitive details need to be shared)
...
- Open a [GitHub Security Advisory](https://github.com/MobileTeleSystems/bretrics-web/security/advisories/new)
